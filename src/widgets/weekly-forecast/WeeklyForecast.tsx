      ...
      <table className="w-full text-sm table-fixed">
        ...
        <thead>
          <tr className="border-b border-gray-100">
            <th className="px-5 py-2 text-left text-xs font-medium text-gray-400">날짜</th>
            ...
            <th className="px-5 py-2 text-center text-xs font-medium text-red-400">최고</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-50">
          {daily.map((day) => {
            const isToday = day.dayLabel === '오늘';
            const isTomorrow = day.dayLabel === '내일';
